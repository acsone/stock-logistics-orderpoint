...
class StockLocationOrderpoint(models.Model):
    ...
    def _run_replenishment(self, products=None, processed=None, job_logs=None):
        ...
        if not procurement_data:
            # No procurement data means no demand to replenish.
            # But we may still have existing replenishment moves that need
            # to be escalated.
            escalated_moves = self._escalate_covering_replenishment_moves(
                products or self.env["product.product"]
            )
