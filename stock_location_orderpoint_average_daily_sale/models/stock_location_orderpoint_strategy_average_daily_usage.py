...
class StockLocationOrderpointStrategyAverageDailyUsage(models.AbstractModel):
    ...
    def _compute_demand(self, orderpoint, products) -> dict[int, float]:
        ...
        location_domain = orderpoint._get_daily_usage_products_location_domain(
            orderpoint.id
        )
        ...
        outgoing_moves_domain = orderpoint._get_consuming_moves_domain(orderpoint.id)
        ...
        domain_quant, _im, _om = orderpoint._get_dest_domains(orderpoint.id)
